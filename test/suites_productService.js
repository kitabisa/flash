...
const create = require('../object/create_ServiceGroup')
const update = require('../object/update_ServiceGroup')
const getAll = require('../object/getall_ServiceGroup')
const getdetailpublic = require('../object/getdetailpublic_ServiceGroup')
const getdetail = require('../object/getdetail_ServiceGroup')
const getAllpublic = require('../object/getallpublic_ServiceGroup')
const deleted = require('../object/delete_ServiceGroup')
